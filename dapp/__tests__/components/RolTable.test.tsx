...
describe('RolTable – Calidad', () => {
  it('renderiza la tabla con roles', () => {
    render(<RolTable roles={mockRoles} loading={false} isOwner={true} onModificar={jest.fn()} onInhabilitar={jest.fn()} onHistorial={jest.fn()} />);
  ...
  it('muestra estado de carga (skeleton) cuando loading es true', () => {
    render(<RolTable roles={[]} loading={true} isOwner={true} onModificar={jest.fn()} onInhabilitar={jest.fn()} onHistorial={jest.fn()} />);
    expect(screen.getByTestId('rol-table-loading')).toBeInTheDocument();
  });

  it('muestra empty state cuando no hay roles', () => {
    render(<RolTable roles={[]} loading={false} isOwner={true} onModificar={jest.fn()} onInhabilitar={jest.fn()} onHistorial={jest.fn()} />);
  ...
  it('llama a onModificar con el rol correcto', () => {
    ...
    render(<RolTable roles={mockRoles} loading={false} isOwner={true} onModificar={onModificar} onInhabilitar={jest.fn()} onHistorial={jest.fn()} />);
  ...
  it('llama a onInhabilitar con el rol correcto', () => {
    ...
    render(<RolTable roles={mockRoles} loading={false} isOwner={true} onModificar={jest.fn()} onInhabilitar={onInhabilitar} onHistorial={jest.fn()} />);
  ...
  it('no muestra botones de accion si no es owner', () => {
    render(<RolTable roles={mockRoles} loading={false} isOwner={false} onModificar={jest.fn()} onInhabilitar={jest.fn()} onHistorial={jest.fn()} />);
