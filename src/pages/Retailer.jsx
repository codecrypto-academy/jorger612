...
import { Store, Package, ArrowRight, CheckCircle, AlertCircle, MapPin, ShoppingCart } from 'lucide-react'
...
const Retailer = () => {
  ...
  const eventTypes = [
    { value: 'RECEIVED_FROM_WHOLESALER', label: 'Recibido del Mayorista', color: 'text-green-600' },
    { value: 'STORE_INVENTORY', label: 'Agregado al Inventario de Tienda', color: 'text-blue-600' },
    { value: 'DISPLAY_READY', label: 'Listo para Exhibición', color: 'text-purple-600' },
    { value: 'SOLD_TO_CUSTOMER', label: 'Vendido al Cliente', color: 'text-red-600' },
    { value: 'RETURNED_BY_CUSTOMER', label: 'Devuelto por Cliente', color: 'text-yellow-600' },
    { value: 'DAMAGED_PRODUCT', label: 'Producto Dañado', color: 'text-gray-600' }
  ]
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Minorista</h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Registra la llegada de productos y prepara para venta al consumidor. 
          Gestiona el inventario final y las transacciones con clientes.
        </p>
      </div>
      ...
      <div className="card bg-blue-50 border-blue-200">
        <h3 className="text-lg font-semibold text-blue-900 mb-4">Instrucciones del Minorista</h3>
        <div className="space-y-2 text-blue-800 text-sm">
          <p>• <strong>Recibido del Mayorista:</strong> Registra cuando llega un producto del mayorista</p>
          <p>• <strong>Agregado al Inventario:</strong> Confirma que el producto está en el inventario de la tienda</p>
          <p>• <strong>Listo para Exhibición:</strong> Registra que el producto está listo para la venta</p>
          <p>• <strong>Vendido al Cliente:</strong> Confirma la venta del producto al consumidor final</p>
          <p>• <strong>Devuelto por Cliente:</strong> Registra devoluciones de productos</p>
          <p>• <strong>Producto Dañado:</strong> Registra productos que no pueden venderse</p>
      ...
      <div className="card bg-green-50 border-green-200">
        <h3 className="text-lg font-semibold text-green-900 mb-4">Información para Clientes</h3>
        <div className="space-y-2 text-green-800 text-sm">
          <p>• Los clientes pueden consultar la trazabilidad completa de cualquier producto</p>
          <p>• Cada producto tiene un código único que permite rastrear todo su recorrido</p>
          <p>• La información incluye fechas, organizaciones y ubicaciones de cada paso</p>
          <p>• Todas las transacciones están verificadas criptográficamente</p>
          <p>• Los clientes pueden verificar la autenticidad de cada evento</p>
        </div>
      </div>
    </div>
  )
