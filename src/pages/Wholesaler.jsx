...
import { Truck, Package, ArrowRight, CheckCircle, AlertCircle, MapPin } from 'lucide-react'
...
const Wholesaler = () => {
  ...
  const eventTypes = [
    { value: 'RECEIVED_FROM_WAREHOUSE', label: 'Recibido del Almacén', color: 'text-green-600' },
    { value: 'QUALITY_INSPECTION', label: 'Inspección de Calidad', color: 'text-blue-600' },
    { value: 'PACKAGED_FOR_DISTRIBUTION', label: 'Empacado para Distribución', color: 'text-purple-600' },
    { value: 'SHIPPED_TO_RETAILER', label: 'Enviado al Minorista', color: 'text-orange-600' },
    { value: 'INVENTORY_UPDATE', label: 'Actualización de Inventario', color: 'text-indigo-600' }
  ]
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Mayorista</h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Gestiona la distribución a gran escala con verificación de origen. 
          Registra la recepción, inspección y envío de productos a minoristas.
        </p>
      </div>
      ...
      <div className="card bg-blue-50 border-blue-200">
        <h3 className="text-lg font-semibold text-blue-900 mb-4">Instrucciones del Mayorista</h3>
        <div className="space-y-2 text-blue-800 text-sm">
          <p>• <strong>Recibido del Almacén:</strong> Registra cuando llega un producto del almacén</p>
          <p>• <strong>Inspección de Calidad:</strong> Confirma que el producto cumple estándares</p>
          <p>• <strong>Empacado para Distribución:</strong> Registra el empaquetado para envío</p>
          <p>• <strong>Enviado al Minorista:</strong> Confirma el envío al minorista final</p>
          <p>• <strong>Actualización de Inventario:</strong> Registra cambios en el inventario</p>
